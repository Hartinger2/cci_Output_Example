...
{  /* Cyclic VTClient function */
	...
	CYCLE_4B(I2);
	if (CYCLE_4B.Q0) IsoVtcCmd_CtrlAudioSignal(psEvData->u8Instance, 1, 100,  500, 0);
	if (CYCLE_4B.Q1) IsoVtcCmd_CtrlAudioSignal(psEvData->u8Instance, 1, 1000, 1000, 0);
	if (CYCLE_4B.Q2) IsoVtcCmd_CtrlAudioSignal(psEvData->u8Instance, 1, 2000, 500, 0);
